...
class Constants(BaseConstants):
    name_in_url = 'TPOGcontN'
    players_per_group = 2
    num_rounds = 10
    instructions_template = 'TPOGcontN/instructions.html'
    table_template = 'TPOGcontN/table.html'
...
class Group(BaseGroup):
    ...
    expect_receiver = models.CurrencyField(
        min=0, max=Constants.endowment_Decider - 2, doc="""Amount expected by P2"""
    )
...
class SendBack(Page):
    ...
    form_model = 'group'
    form_fields = ['sent_back_amount', 'expect_receiver']
